...
select [Owner] as UserEmail, exp_type.ExpenseType, DetailTypeName as ExpenseDetail, Currency, Expensed as ExpenseAmount, CrtDate as CreateDate from [dbo].[SYS_EXPENSE_MASTER] exp_main
