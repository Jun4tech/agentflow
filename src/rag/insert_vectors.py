...
# Read the CSV file
df = pd.read_csv("../data/rag/schema_metadata.csv", sep=";")
...
def prepare_record(row):
    ...
    """
    content = f"Table Name: {row['table_name']}, Column Name: {row['column_name']}, Data Type: {row['data_type']}, Description: {row['description']}"
...
# vec.delete()  # Delete all existing records
# vec.create_tables()
